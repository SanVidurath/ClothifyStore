...
import model.BaseOrderOrderDetail;
import model.Order;
...
public class OrdersAndReturnsFormController implements Initializable {
    ...
    void btnReloadOnAction(ActionEvent event) {
        ...
        try {
            List<Order> orderList = new OrderController().getAll();
            List<OrderDetail> orderDetailList = new OrderDetailController().getAll();
    ...
    void btnReturnOnAction(ActionEvent event) {
        ...
        if (buttonType.isPresent() && buttonType.get().getText().equals("OK")) {
            ...
            try {
                boolean isAddedOrderReturn = new OrderReturnsController().add(orderReturn);
                if(isAddedOrderReturn){
                    new Alert(Alert.AlertType.INFORMATION,"order return has been successfully placed").show();
                }else{
